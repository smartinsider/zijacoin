...
In order to support loading of multiple wallets in zija-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zija.cpp.
...
Changes to zija.cpp
----------------------
zija.cpp is the entry point into zija-qt, and as such, will require some minor modifications to provide hooks for
