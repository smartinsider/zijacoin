Contributing to ZIJA Core
============================

The ZIJA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ZIJA Core project, and is not to be
confused with overall ZIJA Network Protocol consensus changes.

Whether a pull request is merged into ZIJA Core rests with the project merge
...
Patches that change ZIJA consensus rules are considerably more involved than
...
Where a patch set proposes to change the ZIJA consensus, it must have been
...
The project leader is the release manager for each ZIJA Core release.
