...
#if defined(NDEBUG)
# error "Zijacoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Zijacoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("zijacoin-scriptch");
...
bool AcceptBlock(CBlock& block, CValidationState& state, CDiskBlockPos* dbp)
{
    ...
    if (hash != Params().HashGenesisBlock()) {
        ...
        // Zijacoin did not enable this BIP 34
        // TBD
        /*
        if (block.nVersion >= 3)
        {
