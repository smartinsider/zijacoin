                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ZIJA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZIJA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zija: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZIJA Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZIJA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZIJA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZIJA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZIJA addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZIJA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ZIJA Core help message to get a list with possible ZIJA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZIJA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZIJA network", "", count));
}
...
{
    QString strTitle = tr("ZIJA Core"); // default title
