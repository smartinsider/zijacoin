...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ZIJA");
    case mBTC: return QString("mZIJA");
    case uBTC: return QString::fromUtf8("μZIJA");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Zijacoins");
    case mBTC: return QString("Milli-Zijacoins (1 / 1,000)");
    case uBTC: return QString("Micro-Zijacoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
