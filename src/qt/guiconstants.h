...
/* Zija GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ZIJA"
#define QAPP_ORG_DOMAIN "zija.icu"
#define QAPP_APP_NAME_DEFAULT "ZIJA-Qt"
#define QAPP_APP_NAME_TESTNET "ZIJA-Qt-testnet"
